...
final class Plotter extends DummyPlotter
{
    ...
    private void plotRegions()
    {
        for (int i = 0; i < numberOfRegions(); i++) {
            ...
            // System.out.println("x=" + r.x()*100 + ", y=" + r.y()*100 + ", w=" + r.width()*100 + ", h=" +
            // r.height()*100);
            // System.out.println();
    ...
    /**
     * This needs to be overridden because there is no access to the list of regions in order to add one
     * ourselves.
     */

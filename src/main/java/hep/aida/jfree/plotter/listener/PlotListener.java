...
/**
 * This listener class is used to update the JFreeChart graphics on the fly as AIDA objects are changed by their fill
...
public abstract class PlotListener<T> implements AIDAListener, ChartProgressListener {
    ...
    /**
     * This method updates the JFreeChart plot based on changes to the AIDA object. Sub-classes should override this
    ...
    /**
     * Receive notification of a <code>ChartProgressEvent</code> which is used to set this object as valid for updates
     * after a chart redraw has finished.
     * 

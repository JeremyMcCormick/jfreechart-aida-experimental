 ...
 */
public class XYVariableBinWidthBoxRenderer extends AbstractXYItemRenderer {
    
    double maximumValue = 1.0;

    public XYVariableBinWidthBoxRenderer() {
    }
    ...
    private double computeScaledValue(double binSize, double value) {
